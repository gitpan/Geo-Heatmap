...
#     NAME => q[Geo::Heatmap]
#     PREREQ_PM => { Test::Most=>q[0], Imager=>q[0.94], CHI=>q[0.56], Moose=>q[2.0604] }
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) '  Imager: 0.94' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '            "Imager" : "0.94",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Imager::" VERSION="0.94" />' >> $(DISTNAME).ppd
